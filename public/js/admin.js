...
function sendCategory() {
    ...
    fetch('https://nezhnaya-vanil.onrender.com/add-category', {
        method: 'POST',
        headers: {
...
function sendProduct() {
    ...
    fetch('https://nezhnaya-vanil.onrender.com/add-product', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
...
function loadProducts() {
    fetch('https://nezhnaya-vanil.onrender.com/api/products')
    .then(response => response.json())
    .then(products => {
...
function updateProduct(id, field, value) {
    fetch(`https://nezhnaya-vanil.onrender.com/api/products/${id}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
...
function loadUsers() {
    fetch('https://nezhnaya-vanil.onrender.com/api/users')
    .then(response => response.json())
    .then(users => {
        displayUsers(users);
    })
...
function updateUser(id, field, value) {
    fetch(`https://nezhnaya-vanil.onrender.com/api/users/${id}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
...
function updateCategory(id, field, value) {
    fetch(`https://nezhnaya-vanil.onrender.com/api/categories/${id}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
...
function searchUsers(query) {
    fetch(`https://nezhnaya-vanil.onrender.com/api/users/search?query=${query}`)
    .then(response => response.json())
    .then(users => {
        displayUsers(users);
    })
...
function searchCategories(query) {
    fetch(`https://nezhnaya-vanil.onrender.com/api/categories/search?query=${query}`)
    .then(response => response.json())
    .then(categories => {
        displayCategories(categories);
    })
